          ...
          <div class="card-body">
            ...
            <div class="col-md-9">
              ...
              <ul class="list-group">
                ...
                <li class="list-group-item"><b>Hireable</b>: ${user.hireable}</li>
                <li class="list-group-item"><b>Twitter</b>: ${user.twitter_username}</li>
                ...
                <li class="list-group-item"><b>Last Activity</b>: ${user.updated_at}</li>
              </ul>
              </div>
            </div>
          </div>
        </div>
        <h3 class="page-header">All Public Repos of : ${user.name}</h3>
        <div id="repos"></div>
        `);
    });
  });
